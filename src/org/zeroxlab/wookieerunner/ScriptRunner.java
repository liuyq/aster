 ...
 *
 * Add local context string execution by Wei-Ning Huang <azhuang@0xlab.org>
 */
...
public class ScriptRunner {
    ...
    private final PythonInterpreter localPython;

    /** Private constructor. */
    private ScriptRunner(Object scope, String variable, String executablePath) {
        initPython(executablePath);

        this.scope = scope;
        this.variable = variable;
        this.localPython = new PythonInterpreter();
    }

    /** Creates a new instance for the given scope object. */
    public static ScriptRunner newInstance(Object scope, String variable, String executablePath) {
        return new ScriptRunner(scope, variable, executablePath);
    }
    ...
    public void runStringLocal(String souce) {
        localPython.exec(souce);
    }
